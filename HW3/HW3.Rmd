...
As the probability of $P(Y \ge m)$ for this gene is less than 0.05, so we can reject the null hypothesis and say that these reads does not come from Poission distribution with mean $L*p0$, therefore these reads are not due to random mapping.
